...
var author$project$Ledger$NewAccount = {$: 'NewAccount'};
var author$project$Main$Ledger = {$: 'Ledger'};
var author$project$Main$Model = F6(
	function (key, currentCategory, ledgerState, panic, auth, settings) {
		return {auth: auth, currentCategory: currentCategory, key: key, ledgerState: ledgerState, panic: panic, settings: settings};
	});
var author$project$Main$ObtainedSettings = function (a) {
	return {$: 'ObtainedSettings', a: a};
};
var author$project$Auth$Permissions = F4(
	function (readAccounts, readTransactions, manageTeams, admin) {
		return {admin: admin, manageTeams: manageTeams, readAccounts: readAccounts, readTransactions: readTransactions};
	});
...
var author$project$Auth$jsonToPermissions = A5(
	elm$json$Json$Decode$map4,
	author$project$Auth$Permissions,
	A2(elm$json$Json$Decode$field, 'readAccounts', elm$json$Json$Decode$bool),
	A2(elm$json$Json$Decode$field, 'readTransactions', elm$json$Json$Decode$bool),
	A2(
		elm$json$Json$Decode$field,
		'manageTeams',
		elm$json$Json$Decode$list(elm$json$Json$Decode$string)),
	A2(elm$json$Json$Decode$field, 'admin', elm$json$Json$Decode$bool));
var author$project$Main$SettingsData = function (defaultPermissions) {
	return {defaultPermissions: defaultPermissions};
};
var elm$json$Json$Decode$map = _Json_map1;
var author$project$Main$jsonToSettings = A2(
	elm$json$Json$Decode$map,
	author$project$Main$SettingsData,
	A2(elm$json$Json$Decode$field, 'defaultPermissions', author$project$Auth$jsonToPermissions));
...
var author$project$Main$fetchSettings = elm$http$Http$get(
	{
		expect: A2(elm$http$Http$expectJson, author$project$Main$ObtainedSettings, author$project$Main$jsonToSettings),
		url: '/api/settings'
	});
var author$project$Panic$None = {$: 'None'};
var author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			A6(author$project$Main$Model, key, author$project$Main$Ledger, author$project$Ledger$NewAccount, author$project$Panic$None, elm$core$Maybe$Nothing, elm$core$Maybe$Nothing),
			author$project$Main$fetchSettings);
	});
...
var author$project$Auth$AuthLevel = F3(
	function (label, permissions, authentified) {
		return {authentified: authentified, label: label, permissions: permissions};
	});
var author$project$Panic$Reason = function (a) {
	return {$: 'Reason', a: a};
};
				...
				if (res.$ === 'Err') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								panic: author$project$Panic$Reason('Could not fetch basic settings')
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var data = res.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								auth: elm$core$Maybe$Just(
									A3(author$project$Auth$AuthLevel, 'Anonymous', data.defaultPermissions, false)),
								settings: elm$core$Maybe$Just(data)
							}),
						elm$core$Platform$Cmd$none);
				}
		}
	});
var author$project$Ledger$ledgerPath = function (page) {
	switch (page.$) {
		case 'AccountList':
			return _List_fromArray(
				[
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$href('/ledger')
								]),
							_List_fromArray(
								[
									elm$html$Html$text('Ledger')
		...
		case 'TxnList':
			var account_name = page.a.account_name;
			return _List_fromArray(
				[
					A2(
					elm$html$Html$li,
					...
					_List_fromArray(
						[
							elm$html$Html$text(account_name)
						]))
				]);
		default:
			var account_name = page.a.account_name;
			var account_id = page.a.account_id;
			return _List_fromArray(
				[
					A2(
					elm$html$Html$li,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$href(
									'/ledger/' + elm$core$String$fromInt(account_id))
								]),
							_List_fromArray(
								[
									elm$html$Html$text(account_name)
...
var author$project$Ledger$ledgerView = function (page) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						elm$html$Html$ul,
						_List_Nil,
						author$project$Ledger$ledgerPath(page))
					]))
			]));
};
var author$project$Loading$loadingView = _List_fromArray(
	[
		elm$html$Html$text('Loading')
	]);
var author$project$Main$navbarAuth = function (model) {
	return _List_fromArray(
		[
			A2(
			elm$html$Html$div,
...
var author$project$Main$Bounties = {$: 'Bounties'};
var author$project$Main$Budget = {$: 'Budget'};
var author$project$Main$Home = {$: 'Home'};
var author$project$Main$Settings = {$: 'Settings'};
var author$project$Main$navbarButtonClass = F2(
	function (model, cat) {
		return _Utils_eq(model.currentCategory, cat) ? elm$html$Html$Attributes$class('navbar-item is-active') : elm$html$Html$Attributes$class('navbar-item');
	});
var author$project$Main$navbarCategories = function (model) {
	return _List_fromArray(
		[
			A2(
			elm$html$Html$a,
			_List_fromArray(
				[
					A2(author$project$Main$navbarButtonClass, model, author$project$Main$Home),
					elm$html$Html$Attributes$href('#')
				]),
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					A2(author$project$Main$navbarButtonClass, model, author$project$Main$Ledger),
					elm$html$Html$Attributes$href('#')
				]),
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					A2(author$project$Main$navbarButtonClass, model, author$project$Main$Budget),
					elm$html$Html$Attributes$href('#')
				]),
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					A2(author$project$Main$navbarButtonClass, model, author$project$Main$Bounties),
					elm$html$Html$Attributes$href('#')
				]),
			_List_fromArray(
				[
					elm$html$Html$text('Bounties')
				])),
			A2(
			elm$html$Html$a,
			_List_fromArray(
				[
					A2(author$project$Main$navbarButtonClass, model, author$project$Main$Settings),
					elm$html$Html$Attributes$href('#')
				]),
			_List_fromArray(
				[
...
var author$project$Main$navbarView = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('navbar top-navbar')
			]),
		_List_fromArray(
			[
				A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$text('backertrack')
											]))
									])),
								A2(
								elm$html$Html$div,
							...
							[
								...
								_List_fromArray(
									[
										...
										author$project$Main$navbarCategories(model))
									])),
								A2(
								elm$html$Html$div,
								_List_fromArray(
								...
								_List_fromArray(
									[
										...
										author$project$Main$navbarAuth(model))
									]))
							]))
					]))
			]));
};
var author$project$Panic$panicView = function (panic) {
	if (panic.$ === 'None') {
		return _List_fromArray(
			[
				elm$html$Html$text('Unexpected panic. This is a bug.')
			]);
	} else {
		var x = panic.a;
		return _List_fromArray(
			[
				elm$html$Html$text('Well fuck: ' + (x + '.'))
			]);
	}
};
var author$project$Main$view = function (model) {
	return {
		body: _Utils_eq(model.panic, author$project$Panic$None) ? (_Utils_eq(model.settings, elm$core$Maybe$Nothing) ? author$project$Loading$loadingView : _List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						if (_n0.$ === 'Ledger') {
							return author$project$Ledger$ledgerView(model.ledgerState);
						} else {
							return A2(
								elm$html$Html$div,
								_List_Nil,
			...
			])) : author$project$Panic$panicView(model.panic),
		title: 'backertrack'
	};
};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Auth.Permissions":{"args":[],"type":"{ readAccounts : Basics.Bool, readTransactions : Basics.Bool, manageTeams : List.List String.String, admin : Basics.Bool }"},"Main.SettingsData":{"args":[],"type":"{ defaultPermissions : Auth.Permissions }"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"ObtainedSettings":["Result.Result Http.Error Main.SettingsData"]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}}}}})}});
...
},{"./Main.elm":"Main.elm"}],"C:/Users/theod/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/theod/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","bootstrap.js"], null)
//# sourceMappingURL=/bootstrap.91d3c14f.map